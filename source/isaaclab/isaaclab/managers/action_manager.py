...
class ActionManager(ManagerBase):
    ...
    * apply actions: This operation typically sets the processed actions into the assets in the
    ...
    def __init__(self, cfg: object, env: ManagerBasedEnv):
        ...
        self._pp_action = torch.zeros_like(self._action)
    ...
    @property
    def pp_action(self) -> torch.Tensor:
        """The previous actions of previous actions sent to the environment. Shape is (num_envs, total_action_dim)."""
        return self._pp_action
    ...
    def process_action(self, action: torch.Tensor):
        ...
        self._pp_action[:] = self._prev_action
