...
class LejuRewards(RewardsCfg):
    ...
    dof_pos_limits = RewTerm(
        func=mdp.joint_pos_limits, weight=-1.0, params={"asset_cfg": SceneEntityCfg("robot", joint_names=["leg_l6_joint", "leg_r6_joint"])}
    )
    # Penalize deviation from default of the joints that are not essential for locomotion
    joint_deviation_hip = RewTerm(
        func=mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["leg_l1_joint", "leg_l2_joint", "leg_r1_joint", "leg_r2_joint"])},
    )
    joint_deviation_arms = RewTerm(
        func=mdp.joint_deviation_l1,
        weight=-0.2,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=["zarm_l1_joint", "zarm_l2_joint", "zarm_l4_joint", "zarm_r1_joint", "zarm_r2_joint", "zarm_r4_joint"])},
    )
