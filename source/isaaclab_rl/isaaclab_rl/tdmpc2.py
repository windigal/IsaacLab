...
"""Wrapper to configure an environment instance to TD-MPC2 environment.

The following example shows how to wrap an environment for TD-MPC2:

.. code-block:: python

    from isaaclab_rl.tdmpc2 import TDMPCEnvWrapper

    env = TDMPCEnvWrapper(env)
...
class TDMPCEnvWrapper(gym.Wrapper):

    def __init__(self, env: ManagerBasedRLEnv | DirectRLEnv, cfg):
