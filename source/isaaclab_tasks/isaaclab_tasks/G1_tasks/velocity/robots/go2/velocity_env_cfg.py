...
from isaaclab_assets.robots.go2 import UNITREE_GO2_CFG as ROBOT_CFG
...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        "flat":
        terrain_gen.MeshPlaneTerrainCfg(proportion=1),
        # "random_rough":
        ...
        #                                       border_width=0.25),
        # "hf_pyramid_slope":
        # terrain_gen.HfPyramidSlopedTerrainCfg(proportion=0.05,
        #                                       slope_range=(0.0, 0.4),
        #                                       platform_width=2.0,
        #                                       border_width=0.25),
        # "hf_pyramid_slope_inv":
        # terrain_gen.HfInvertedPyramidSlopedTerrainCfg(proportion=0.05,
        #                                               slope_range=(0.0, 0.4),
        #                                               platform_width=2.0,
        #                                               border_width=0.25),
        # "boxes":
        # terrain_gen.MeshRandomGridTerrainCfg(proportion=0.3,
        #                                      grid_width=0.45,
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    contact_forces = ContactSensorCfg(prim_path="{ENV_REGEX_NS}/Robot/.*",
                                      history_length=3,
                                      track_air_time=True)
    thigh_contacts = ContactSensorCfg(prim_path="{ENV_REGEX_NS}/Robot/.*_thigh",
                                      update_period=0.005)
    calf_contacts = ContactSensorCfg(prim_path="{ENV_REGEX_NS}/Robot/.*_calf", update_period=0.005)
    foot_contacts = ContactSensorCfg(prim_path="{ENV_REGEX_NS}/Robot/.*_foot", update_period=0.005)
    # lights
...
class EventCfg:
    ...
    physics_material = EventTerm(
        ...
        params={
            ...
            "static_friction_range": (0.05, 2.75),
            "dynamic_friction_range": (0.05, 2.75),
    ...
    # set_joint_limit = EventTerm(
    #     func=mdp.set_joint_limit,
    #     mode="startup",
    #     params={
    #         "asset_cfg": SceneEntityCfg("robot", body_names=".*"),
    #         "joint_ids": [0, 1, 2, 3],
    #         "lower_limit_params": -0.4,
    #         "upper_limit_params": 0.4, 
    #     }
    # )
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformLevelVelocityCommandCfg(
        ...
        flat_resampling_time_range=(5.0, 5.0),
        ...
        flat_ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(lin_vel_x=(-0.0, 0.0),
                                                              lin_vel_y=(-0.0, 0.0),
                                                              ang_vel_z=(-0.1, 0.1),
                                                              heading=(-math.pi, math.pi)),
        ...
        #                                                       ang_vel_z=(-0.5, -0.5), 
        #                                                       heading=(-math.pi, math.pi)),
        limit_ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(lin_vel_x=(-1.0, 1.0),
                                                               lin_vel_y=(-0.5, 0.5),
                                                               ang_vel_z=(-0.5, 0.5), 
                                                               heading=(-math.pi, math.pi)),
        flat_limit_ranges=mdp.UniformLevelVelocityCommandCfg.Ranges(lin_vel_x=(-0.0, 0.0),
                                                                    lin_vel_y=(-0.0, 0.0),
                                                                    ang_vel_z=(-1.0, 1.0), 
                                                                    heading=(-math.pi, math.pi)),
    )
...
class ObservationsCfg:
    ...
    class CriticCfg(ObsGroup):
        ...
        leg_contacts = ObsTerm(func=mdp.thigh_and_calf_contacts,
                               params={
                                   "thigh_sensor_name": "thigh_contacts",
                                   "calf_sensor_name": "calf_contacts",
                                   "threshold": 1.0
                               })
        feet_forces = ObsTerm(func=mdp.foot_contact_forces,
                              params={
                                  "sensor_name": "foot_contacts",
                                  "scale": 0.005
                              })
        # feet_height = ObsTerm(func=mdp.feet_height,
...
class CTSRewardsCfg:
    ...
    # -- task
    track_lin_vel_xy = RewTerm(func=mdp.track_lin_vel_xy_exp,
                               weight=1.0,
                               params={
                                   "command_name": "base_velocity",
                                   "std": math.sqrt(0.25)
    ...
    joint_deviation = RewTerm(func=mdp.joint_deviation_l1, weight=-0.1, params={
            "asset_cfg": SceneEntityCfg("robot", joint_names=[".*_hip_.*"])})
    ...
    dof_pos_limits = RewTerm(func=mdp.joint_pos_limits, weight=-30.0)
    # feet_air_time = RewTerm(
    #     func=mdp.feet_air_time,
    #     weight=1.0,
    #     params={
...
class CurriculumCfg:
    ...
    # heading_cmd_levels = CurrTerm(mdp.heading_cmd_levels)
