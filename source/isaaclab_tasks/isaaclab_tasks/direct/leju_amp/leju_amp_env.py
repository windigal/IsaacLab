...
from .leju_amp_env_cfg import LejuAmpEnvCfg
from .motions import MotionLoader


class LejuAmpEnv(DirectRLEnv):
    cfg: LejuAmpEnvCfg

    def __init__(self, cfg: LejuAmpEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        # self._incompatible_joint_names = ["leg_l1_joint", "leg_l2_joint", "leg_l6_joint",
        #                                   "leg_r1_joint", "leg_r2_joint", "leg_r6_joint",
    ...
    def _get_observations(self) -> dict:
        ...
        obs = compute_obs(
            self.robot.data.joint_pos[:, self.lab_dof_index],
            self.robot.data.joint_vel[:, self.lab_dof_index],
    ...
    def collect_reference_motions(self, num_samples: int, current_times: np.ndarray | None = None) -> torch.Tensor:
        ...
        times = (np.expand_dims(current_times, axis=-1) 
                 - self._motion_loader.dt * np.arange(0, self.cfg.num_amp_observations)).flatten()
        # get motions
        (dof_positions,
         dof_velocities,
         body_positions,
