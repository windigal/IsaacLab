...
class MotionViewer:
    ...
    def __init__(self, motion_file: str, device: torch.device | str = "cpu", index: int = 0, render_scene: bool = False) -> None:
        ...
        # load motions
        self._motion_loader = MotionLoader(motion_file=motion_file, device=device, index=index)
...
if __name__ == "__main__":
    ...
    viewer = MotionViewer(args.file, render_scene=args.render_scene, index=args.index)
    viewer.show()
